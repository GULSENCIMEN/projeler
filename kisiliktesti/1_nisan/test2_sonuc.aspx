<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="test2_sonuc.aspx.cs" Inherits="_1_nisan.test2_sonuc" %>
    ...
    <table style="width:100%;">
        <tr style="background-color:Aqua">
            ...
            <td class="style5">
                BAĞIMLILIK</td>
            <td class="style6">
                SIKINTILI-ÜZÜNTÜLÜ</td>
                <td class="style7">
                TAKINTILI-SAPLANTILI</td>
         </tr>
      ...
      <tr style="background-color:Aqua">
            ...
            <td class="style2">
                <asp:Label ID="Label130" runat="server" Text="Label"></asp:Label>
            </td>
            <td>
            ...
            <td >
                <asp:Label ID="Label142" runat="server" Text="Label"></asp:Label>
            </td>
            </tr>
             <tr style="background-color:Lime">
            ...
            <td >
                <asp:Label ID="Label146" runat="server" Text="Label"></asp:Label>
            </td>
            <td >
            ...
            <td>
                <asp:Label ID="Label166" runat="server" Text="Label"></asp:Label>
            </td>
            <td>
            ...
            <td>
             ...
             <tr style="background-color:Aqua">
             <td>
            <asp:Label ID="Label178" runat="server" Text="Label"></asp:Label>
            </td>
            <td >
            ...
            <td >
                <asp:Label ID="Label186" runat="server" Text="Label"></asp:Label>
            </td>
            <td>
            ...
            <td>
                <asp:Label ID="Label190" runat="server" Text="Label"></asp:Label>
            </td>
            <td>
            ...
            <td>
                <asp:Label ID="Label194" runat="server" Text="Label"></asp:Label>
            </td>
            <td>
            ...
            <td >
                <asp:Label ID="Label214" runat="server" Text="Label"></asp:Label>
            </td>
             <td>
            ...
            <td>
                <asp:Label ID="Label218" runat="server" Text="Label"></asp:Label>
            </td>
            <td>
