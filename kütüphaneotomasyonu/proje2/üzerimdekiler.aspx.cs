...
namespace proje2
{
    public partial class uzerimdekiler : System.Web.UI.Page
    {
        ...
        public DataTable GetName()
        {
           // SqlConnection baglanti = new SqlConnection("Data Source = RAYBEK; Initial Catalog=LBRY1; User Id=sa; Password=raybek;");
            ...
            try
            {
                ...
                strQueryString.Append("select kitap.kitap_no,kitap.adi,kitap.tür,iade.iade_tarihi from kitap    ");
                strQueryString.Append("inner join iade   ");
                strQueryString.Append("on iade.kitap_no=kitap.kitap_no  ");
                strQueryString.Append("inner join üye  ");
                strQueryString.Append("on üye.tc=iade.tc   ");
