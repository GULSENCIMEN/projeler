...
$sql="SELECT c.adi cicekadi,c.ozellikler cicekozellik,c.resimyolu cicekresim,t.turadi tur,t.turozellik turozellik FROM cicekler c inner join cicekturu t on c.turid=t.turid where c.turid='".$_POST['turid']."'";
$sql1="SELECT *FROM cicekturu WHERE turid='".$_POST['turid']."'";
